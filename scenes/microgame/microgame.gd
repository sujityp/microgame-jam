...
@export_range(2, 10) var game_length : int = 5

## If true, the game will be lost when the timer runs out. If false, the game will be won.
@export var lose_on_end : bool = true
